...
/**
 * A specialization of {@link ListView} that will automatically start to scroll up or down during
 * drag and drop operations whenever the mouse cursor reaches the top or bottom of the view. The
 * view currently only supports vertical orientation, although it should be straight-forward to add
 * horizontal orientation as well.
 *
